...
"""
# -- Constants
# Width of receipt line.
LINE_WIDTH = 40

# Headers to divide receipt sections.
...
def align_lr(left, right):
    """Align a line with left and right justified parts.

    Args:
        left: The part to left justify.
        right The part to right justify.
    """
    return left + ' ' + str(right).rjust(LINE_WIDTH - len(left) - 1)
...
# Saving config example
with open('config/config.yml', 'w') as f:
    yaml.dump({
        'business_name': 'Firefly Baker',
        'bakery_cost': 4.0,
        'coffee_cost': 3.5,
        'tax_rate': 0.075
    })
...
# The reciepts are stored on a seperate file. 
# # old functions
